module managers {
    export class ScoreBoard {
        ...
        public Start() {
            ...
            this._scoreLabel = new objects.Label("Score: 99999", "30px", "Consolas", "#000000", 650, 20, false);
            this._highScoreLabel = new objects.Label("High Score: 9999", "60px", "Consolas", "#000000", 450, 150, true);
